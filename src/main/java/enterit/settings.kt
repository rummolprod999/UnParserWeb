...
var UserEtprf: String? = null
var PassEtprf: String? = null
var UserCap: String? = null
var PassCap: String? = null
    ...
    (0 until settings.length)
        ...
        .forEach {
            when (it.nodeName) {
                ...
                "useretprf" -> UserEtprf = it.childNodes.item(0).textContent
                "passetprf" -> PassEtprf = it.childNodes.item(0).textContent
                "usercaptcha" -> UserCap = it.childNodes.item(0).textContent
                "passcaptcha" -> PassCap = it.childNodes.item(0).textContent
                "token" -> Token = it.childNodes.item(0).textContent
