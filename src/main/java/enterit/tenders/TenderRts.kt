...
class TenderRts(val urlTend: String, val purNum: String, val placingWay: String, val applGuarantee: String, val currency: String, val contrGuarantee: String, val nmck: String) {
    companion object O {
        const val typeFz = 17
    }
